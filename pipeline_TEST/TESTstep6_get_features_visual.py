...
TASKS = [
    ##### TEST set
    {
        "model_name": "finetune_dinov2_auged_weights_only",
        "weight_path": PATH.VIT_WEIGHTS_ROOT / 'finetune_dinov2_auged_weights_only.pt',
        "out_root": PATH.FACE09_V_DINOV2_FT2_TEST,
        "roots": [PATH.ABAW_FACE09_ROOT_TEST]
    },
    {
        "model_name": "finetune_dinov2_auged_weights_only",
        "weight_path": PATH.VIT_WEIGHTS_ROOT / 'finetune_dinov2_auged_weights_only.pt',
        "out_root": PATH.FACE12_V_DINOV2_FT2_TEST,
        "roots": [PATH.ABAW_FACE12_ROOT_TEST]
    },
    {
        "model_name": "finetune_dinov2_auged_weights_only",
        "weight_path": PATH.VIT_WEIGHTS_ROOT / 'finetune_dinov2_auged_weights_only.pt',
        "out_root": PATH.FACE15_V_DINOV2_FT2_TEST,
        "roots": [PATH.ABAW_FACE15_ROOT_TEST]
    },
